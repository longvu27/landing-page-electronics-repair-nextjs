...
export default function DienNuoc() {
  ...
  return (
    <div className={s.wrapper}>
      ...
      <h2>Các Dịch Vụ Điện Nước Chúng Tôi Cung Cấp:</h2>
      <ul>
